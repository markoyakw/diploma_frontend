...
const GetTestedQuestionTypeDeterminator: React.FC<{ question: IQuestion, questionId: number }> = ({ question, questionId }) => {
...
export default GetTestedQuestionTypeDeterminator